    ...
    class CreatePlayerPatch
    {
        ...
        public static void OnComebackMessage(byte Sendto = byte.MaxValue)
        {
            if (Main.UseingJapanese)
            {
                ...
                Utils.SendMessage($"{text}{text2}{text4}{text5}{text6}", Sendto, $"<{Main.ModColor}>【This Room Use \"Town Of Host-N\"】</color>");
            }
            else
            {
                var varsion = Main.PluginShowVersion;
                ...
                Utils.SendMessage($"{text}{text2}", Sendto, $"<{Main.ModColor}>【This Room Use \"Town Of Host-N\"】</color>");
            }
